...
const items = [
	{ Field: 'title<span class="text-error">*</span>', Description: 'String: Title of the message.' },
	{ Field: 'topic<span class="text-error">*</span>', Description: 'String: Kafka topic for the message. (i.e. "hermes.test")' },
	{ Field: 'submitter<span class="text-error">*</span>', Description: 'String: Person or bot submitting the message.' },
...
const data_items = [
	...
	{ Field: 'targets<span class="text-error">*</span><sup class="text-info">&dagger;</sup>', Description: 'List of <code>Target</code>s to reference in the message.' },
...
const reference_items = [
	{ Field: 'source<sup class="text-error">1</sup>', Description: 'String: Source of the reference, e.g. hop_uuid, doi, gracedb_id, or gcn_circular.' },
	{ Field: 'citation<sup class="text-error">1</sup>', Description: 'String: Text to reference in th message, e.g. GCN number.' },
	{ Field: 'url<sup class="text-error">2</sup>', Description: 'String: URL to the reference e.g. https://doi.org/mydoi.' }
]
 
const target_items = [
	{ Field: 'name<span class="text-error">*</span>', Description: 'String: Name of target; will be referenced at the key in other sections like photometry.' },
	{ Field: 'new_discovery', Description: 'Bool: Is this target a new discovery?' },
	{ Field: 'ra<sup class="text-error">1</sup>', Description: 'String or Float: RA of the target; Value can be in sexagesimal or decimal degrees.' },
	{ Field: 'dec<sup class="text-error">1</sup>', Description: 'String or Float: Dec of the target; Value can be in sexagesimal or decimal degrees.' },
	...
	{ Field: 'orbital_elements<sup class="text-error">2</sup>', Description: '<code>Orbital Elements</code>.' },
...
const orbital_items = [
	{ Field: 'epoch_of_elements<span class="text-error">*</span>', Description: 'Date/Time: Epoch of the elements.' },
	{ Field: 'orbital_inclination<span class="text-error">*</span>', Description: 'Float: Orbital inclination in decimal degrees.' },
	{ Field: 'longitude_of_the_ascending_node<span class="text-error">*</span>', Description: 'Float: Longitude of the Ascending Node in decimal degrees.' },
	{ Field: 'argument_of_the_perihelion<span class="text-error">*</span>', Description: 'Float: Argument of the Perihelion in decimal degrees.' },
	{ Field: 'eccentricity<span class="text-error">*</sup>', Description: 'Float: Eccentricity of the orbit.' },
	{ Field: 'semimajor_axis<sup class="text-error">1</sup>', Description: 'Float: Semi-major axis in AU.' },
	{ Field: 'mean_anomaly<sup class="text-error">1</sup>', Description: 'Float: Mean Anomaly in decimal degrees.' },
	{ Field: 'perihelion_distance<sup class="text-error">2</sup>', Description: 'Float: Perihelion Distance in AU.' },
	{ Field: 'epoch_of_perihelion<sup class="text-error">2</sup>', Description: 'Date/Time: Epoch of the nearest perihelion passage, typically for comets.' }
]
...
const photometry_items = [
	{ Field: 'target_name<span class="text-error">*</span>', Description: 'String: Name of the target. Must match the name of a target in the targets section.' },
	{ Field: 'date_obs<span class="text-error">*</span>', Description: 'Date/Time: Date/Time of the observation. Accepts either a float which is assumed JD or an ISO format. (Should be parseable with dateutil.parser.parse.)' },
	{ Field: 'telescope<sup class="text-error">1</sup>', Description: 'String: Telescope used to obtain photometry.' },
	{ Field: 'instrument<sup class="text-error">1</sup><sup class="text-info">&dagger;</sup>', Description: 'String: Instrument used to obtain photometry.' },
	{ Field: 'discovery', Description: 'Bool: Should this point be used as the discovery announcement in TNS?' },
	{ Field: 'brightness<sup class="text-error">2</sup>', Description: 'Float: Brightness measurement.' },
	...
	{ Field: 'bandpass<span class="text-error">*</span>', Description: 'String: Wavelength bandpass used for the observation, e.g. filter.' },
	{ Field: 'exposure_time', Description: 'Float: Exposure time in seconds.' },
	{ Field: 'observer', Description: 'String: Observer(s) of the data.' },
	{ Field: 'limiting_brightness<sup class="text-error">2</sup>', Description: 'Float: 3-sigma limiting brightness of the image.' },
...
const astrometry_items = [
	{ Field: 'target_name<span class="text-error">*</span>', Description: 'String: Name of the target. Must match the name of a target in the targets section' },
	{ Field: 'date_obs<span class="text-error">*</span>', Description: 'Date/Time: Date/Time of the observation. Accepts either a float which is assumed JD or an ISO format. (Should be parseable with dateutil.parser.parse.)' },
	{ Field: 'telescope<sup class="text-error">1</sup>', Description: 'String: Telescope used to obtain astrometry' },
	{ Field: 'instrument<sup class="text-error">1</sup>', Description: 'String: Instrument used to obtain astrometry' },
	{ Field: 'ra<span class="text-error">*</span>', Description: 'String or Float: RA of the target; Value can be in sexagesimal or decimal degrees' },
	{ Field: 'dec<span class="text-error">*</span>', Description: 'String or Float: Dec of the target; Value can be in sexagesimal or decimal degrees' },
	{ Field: 'ra_error', Description: 'Float: Uncertainty on RA' },
	{ Field: 'dec_error', Description: 'Float: Uncertainty on Dec' },
	{ Field: 'ra_error_units', Description: 'String: Units for the error on RA; choices: [degree, arcmin, arcsec, mas]' },
	{ Field: 'dec_error_units', Description: 'String: Units for the error on Dec; choices: [degree, arcmin, arcsec, mas]' },
...
const spectroscopy_items = [
	{ Field: 'target_name<span class="text-error">*</span>', Description: 'String: Name of the target. Must match the name of a target in the targets section.' },
	{ Field: 'date_obs<span class="text-error">*</span>', Description: 'Date/Time: Date/Time of the observation. Accepts either a float which is assumed JD or an ISO format. (Should be parseable with dateutil.parser.parse.)' },
	{ Field: 'telescope<sup class="text-error">1</sup>', Description: 'String: Telescope used to obtain spectra.' },
	{ Field: 'instrument<sup class="text-error">1</sup><sup class="text-info">&dagger;</sup>', Description: 'String: Instrument used to obtain spectra.' },
	{ Field: 'setup', Description: 'String: Setup of the instrument.' },
	{ Field: 'exposure_time', Description: 'Float: Exposure time in seconds.' },
	{ Field: 'flux<span class="text-error">2</span>', Description: 'Array of floats: the flux values of the spectrum.' },
	...
	{ Field: 'wavelength<span class="text-error">2</span>', Description: 'Array of floats: the wavelength values of the spectral bins.' },
	{ Field: 'wavelegnth_unit', Description: 'String: Units of the wavelength values; Choices: [&#8491, nm, &mu;m, Hz, GHz, THz].' },
	{ Field: 'file_info<span class="text-error">2</span>', Description: 'List of Dicts: List of files to upload, with each entry containing 3 keys (name, description, url). References files to upload in multipart/form-data by name.' },
...
<template>
  <v-container fluid>
		<v-expansion-panels>
			<v-expansion-panel title="What is Hermes?">
			...
			<v-expansion-panel title="Access Hermes via an API">
				<v-expansion-panel-text>
					<v-tabs color="primary" v-model="tab">
						<v-tab value="tabOne">Basic API Post</v-tab>
						<v-tab value="tabTwo">Hermes Data Table</v-tab>
						<v-tab value="tabThree">Referencing Files</v-tab>
						<v-tab value="tabFour">TNS AT report</v-tab>
						<v-tab value="tabFive">TNS classification</v-tab>
						<v-tab value="tabSix">Working with SCiMMA credentials</v-tab>
					</v-tabs>
					<v-divider></v-divider>
					<v-tabs-window v-model="tab">
						<v-tabs-window-item value="tabOne">
							<v-container>
								<v-row>
									<b>HERMES message validation and submission can be accessed via API. The available endpoints are as follows:</b>
									<p>
											<b>Validation:</b> <code><a :href="stateStore.hermesUrl + 'api/v0/submit_message/validate/'">{{ stateStore.hermesUrl}}api/v0/submit_message/validate/</a></code>
									</p>
									<p>
											<b>Submission:</b> <code><a :href="stateStore.hermesUrl + 'api/v0/submit_message/'">{{ stateStore.hermesUrl }}api/v0/submit_message/</a></code>
									</p>
								</v-row>
								<v-row>
									<v-col md="6">
										<v-card title="Submitting a message to Hermes API:" variant="tonal">
											<v-card-text>
												...
												<li>Create a header for your submission including the API token from your <a :href="stateStore.hermesUrl + 'profile'">profile</a>.</li>
									...
									<v-col md="6">
										<v-card title="Example Submission (Python Code):" variant="plain">
											<v-card-text class="code-card">
												<pre>
import requests

hermes_submit_url = '{{ stateStore.hermesUrl }}api/v0/submit_message/'
...
response = requests.post(url=hermes_submit_url, json=message, headers=headers)
						...
						<v-tabs-window-item value="tabTwo">
							<v-container>
								<v-row>
									<v-col md="6">
										<v-card title="Construct your Data Dictionary:" variant="tonal">
											<v-card-text>
									...
									<v-col md="6">
										<v-card title="Example Data Dictionary (Python Code):" variant="plain">
											<v-card-text class="code-card">
												<pre>
'data': {
	'targets': [{
	...
	'extra_info': {
			...
			'key2': 'value2',
						...
						<v-tabs-window-item value="tabThree">
							<v-container>
								<v-row>
								...
								<v-row>
									<v-col md="6">
										<v-card title="Submitting a message with files to upload:" variant="tonal">
											<v-card-text>
...
response = requests.post(url=hermes_submit_url, data=data, files=files, headers=headers)
						...
						<v-tabs-window-item value="tabFour">
							<v-container>
								<v-row>
									...
									<p>
										<b>Validation:</b> <code><a :href="stateStore.hermesUrl + 'api/v0/submit_message/validate/'">{{ stateStore.hermesUrl}}api/v0/submit_message/validate/</a></code> (Only accepts json data without files)
									</p>
									<p>
										<b>Submission:</b> <code><a :href="stateStore.hermesUrl + 'api/v0/submit_message/'">{{ stateStore.hermesUrl }}api/v0/submit_message/</a></code>
									</p>
								...
								<v-row>
									<v-col md="6">
										<v-card title="Submitting a message to Hermes API and TNS:" variant="tonal">
											<v-card-text>
												<b>Using your Hermes API Token and the above submission API path, you can use Hermes to submit a message to a kafka topic.</b>
												<li>Create a header for your submission including the API token from your <a :href="stateStore.hermesUrl + 'profile'">profile</a>.</li>
...
response = requests.post(url=hermes_submit_url, data=data, files=files, headers=headers)
						...
						<v-tabs-window-item value="tabFive">
							<v-container>
								<v-row>
...
response = requests.post(url=hermes_submit_url, data=data, files=files, headers=headers)
						...
						<v-tabs-window-item value="tabSix">
							<v-container>
								<v-row>
									...
									through HopSkotch on your behalf. They include a username that you can get from your <a :href="stateStore.hermesUrl + 'profile'">Hermes profile</a>. In general
			...
			<v-expansion-panel title="API Schema Registry">
				<v-expansion-panel-text>
					<v-data-table
					striped="odd"
					density="compact"
					...
					<v-card>
						<p class="text-error">* Required. </p>
						<p class="text-info"><sup>&dagger;</sup> Required if <code>submit_to_tns</code> is set to true.</p>
					</v-card>
					<h2>Data Section</h2>
					<v-data-table
						striped="odd"
					...
					<v-card>
						<p class="text-error">* At least one <code>target</code> is required when including <code>photometry</code>,
						<code>spectroscopy</code>, or <code>astrometry</code> data.</p>
						<p class="text-info"><sup>&dagger;</sup> Required if <code>submit_to_tns</code> is set to true.</p>
					</v-card>
					<v-divider thickness="4" class="pt-2"></v-divider>
					<v-card>
						<v-tabs color="primary" v-model="apiTab">
							<v-tab value="referenceTab">Reference</v-tab>
							<v-tab value="targetTab">Target</v-tab>
							<v-tab value="photometryTab">Photometry</v-tab>
							<v-tab value="spectroscopyTab">Spectroscopy</v-tab>
							<v-tab value="astrometryTab">Astrometry</v-tab>
						</v-tabs>
						<v-divider></v-divider>
						<v-tabs-window v-model="apiTab">
							<v-tabs-window-item value="referenceTab">
								<v-data-table
									striped="odd"
									density="compact"
									:headers="headers"
								...
								<p class="text-error">
									<sup>1,2</sup> Either both <code>source</code> and <code>citation</code>, or a <code>url</code> is required.
								</p>
							</v-tabs-window-item>
							<v-tabs-window-item value="targetTab">
								<v-data-table
									striped="odd"
									density="compact"
									:headers="headers"
							...
							<v-tabs-window-item value="photometryTab">
								<v-data-table
									striped="odd"
									density="compact"
									:headers="headers"
									:items="photometry_items"
									hide-default-footer>
									<template v-slot:item.Field="{ value }">
										<span v-html="value"></span>
									</template>
							...
							<v-tabs-window-item value="spectroscopyTab">
								<v-data-table
									striped="odd"
									density="compact"
									:headers="headers"
									:items="spectroscopy_items"
									hide-default-footer>
									<template v-slot:item.Field="{ value }">
										<span v-html="value"></span>
									</template>
							...
							<v-tabs-window-item value="astrometryTab">
								<v-data-table
									striped="odd"
									density="compact"
									:headers="headers"
									:items="astrometry_items"
									hide-default-footer>
									<template v-slot:item.Field="{ value }">
										<span v-html="value"></span>
									</template>
		...
		<div>
			<hr />
			<v-row>
				<v-col class="text-primary text-left">
