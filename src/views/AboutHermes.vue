            ...
            <div class="accordion" role="tablist">
                ...
                <b-card no-body class="mb-1" border-variant="primary">
                    ...
                    <b-collapse id="accordion-3" visible accordion="my-accordion" role="tabpanel">
                        <b-card-body>
                            <b-card-text>
                                HERMES message validation and submission can be accessed via API. The HERMES message schema
                                is as follows:
...
export default {
    data() {
        return {
            items: [
                { Field: 'title', Description: 'String: Title of the message, required if message is set' },
            ...
            reference_items: [
                { Field: 'source', Description: 'String, required: Source of the reference, e.g. GCN' },
                { Field: 'citation', Description: 'String, required: Text to reference in th message, e.g. GCN number' },
                { Field: 'url', Description: 'String, required: URL to the reference e.g. doi.org/mydoi' }
            ],
            target_items: [
            ...
            photometry_items: [
                { Field: 'target_name', Description: 'String: Name of the target; foreign key to target section' },
                { Field: 'date_obs', Description: 'Date/Time: Date/Time of the observation. If a float is given, we assume the value is JD if it is greater than  2,400,000.5; otherwise we assume MJD' },
